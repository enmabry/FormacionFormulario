<template>
    <div class="MiModal">
        <div class="MegaContainer">
            <div class="Titulo">
                <h2 class="Titular">Ver información Residente</h2>
            </div>
            <div class="Volver">
                ...
                <div class="SubContainer">
                    <div class="Foto">
                        <div class="Fotito">
                            ...
                            <img  class="icon" src="../assets/avatar.svg" />
                            <img   alt=" " class="iconprincipal" />
                        </div>
                    </div>
...
export default {
    ...
    async created() {
        ...
        console.log('Hola don pepe' , this.recordData);
    },
    methods: {
        async fetchData() {
            try {
